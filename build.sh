...
cd $BASE/$OUTPUT && cmake ../ -DCMAKE_BUILD_TYPE=Release -DCMAKE_INSTALL_PREFIX=$BASE/$OUTPUT -DWITH_TESTS=${WITH_TESTS} -DWITH_TOOLS=ON -DWITH_TERARK_ZIP=ON -DWITH_TBB=ON -DDISABLE_STALL_NOTIF=ON
